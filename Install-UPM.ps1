...
<#
.SYNOPSIS
    Universal Package Manager v3.0.2 Installation Script
.DESCRIPTION
    Installs and configures the Universal Package Manager v3.0.2 as a Windows scheduled task
...
Write-Host "Universal Package Manager v3.0.2 Installation" -ForegroundColor Cyan
...
Write-Host ""
Write-InstallLog "Universal Package Manager v3.0.2 installation process complete!" -Level "Success"
